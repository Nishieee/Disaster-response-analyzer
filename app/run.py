...
# load data
engine = create_engine('sqlite:////Users/nishitamatlani/Downloads/Disaster_Response_Pipeline-main/data/DisasterResponse.db')
df = pd.read_sql_table('messages', engine)


# load model
model = joblib.load("/Users/nishitamatlani/Downloads/Disaster_Response_Pipeline-main/models/classifier.pk")
